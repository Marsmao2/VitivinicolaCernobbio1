  ...
  return (
    <section className="py-12 bg-white">
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        {/* Italiano */}
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-center">Descrizione (Italiano)</h3>
        ...
        {/* Inglese */}
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-center">Description (English)</h3>
