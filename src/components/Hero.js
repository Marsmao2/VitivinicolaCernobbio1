      ...
      <div className="relative z-10 text-center text-black max-w-3xl px-4 space-y-6">
        ...
        <div className="space-y-4 text-left">
          ...
          <p className="text-base md:text-lg leading-relaxed italic">
            ...
            Awarded the Gold Medal for Heroic Viticulture, we manually cultivate disease-resistant grape varieties on south-facing terraced slopes, where each vine row embraces both sun and stone.  
            Our winemaking combines the classic barrique method with the innovative “wine in the stone” technique, where the stone becomes an active part of the process, uniquely enhancing the authentic character of the land.  
